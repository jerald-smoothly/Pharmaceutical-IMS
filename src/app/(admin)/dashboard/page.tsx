...
import TodayLabel from "@/components/shared/TodayLabel";
      ...
      <div className="px-8 py-[26px] pb-9 flex flex-col gap-[22px]">
        ...
        <div className="grid grid-cols-3 gap-[18px]">
          ...
          <Link href="/orders" className="block group">
            <div className="bg-[var(--rx-surface)] border border-[var(--rx-border)] rounded-2xl p-5 transition-all group-hover:shadow-[0_6px_22px_-10px_rgba(15,23,41,0.22)] group-hover:border-[var(--rx-text-faint)]">
              <div className="flex items-center justify-between">
                <span className="text-[13px] font-medium text-[var(--rx-text-secondary)]">Total Orders</span>
                <div className="w-[34px] h-[34px] rounded-[9px] bg-[var(--rx-sb-active-bg)] flex items-center justify-center">
              ...
              <div className="mt-[14px]">
                <span className="text-[32px] font-bold tracking-[-1px] text-[var(--rx-text-strong)] leading-none">{orders.toLocaleString()}</span>
              </div>
              <div className="mt-2 text-[12px] text-[var(--rx-text-muted)]">All time</div>
            </div>
          </Link>
          ...
          <Link href="/crm/contacts" className="block group">
            <div className="bg-[var(--rx-surface)] border border-[var(--rx-border)] rounded-2xl p-5 transition-all group-hover:shadow-[0_6px_22px_-10px_rgba(15,23,41,0.22)] group-hover:border-[var(--rx-text-faint)]">
              <div className="flex items-center justify-between">
                <span className="text-[13px] font-medium text-[var(--rx-text-secondary)]">Active Contacts</span>
                <div className="w-[34px] h-[34px] rounded-[9px] bg-[#f1eafb] dark:bg-[#7c3aed]/15 flex items-center justify-center">
              ...
              <div className="mt-[14px]">
                <span className="text-[32px] font-bold tracking-[-1px] text-[var(--rx-text-strong)] leading-none">{contacts.toLocaleString()}</span>
              </div>
              <div className="mt-2 text-[12px] text-[var(--rx-text-muted)]">across {companies} companies</div>
            </div>
          </Link>
          ...
          <Link href="/crm/companies" className="block group">
            <div className="bg-[var(--rx-surface)] border border-[var(--rx-border)] rounded-2xl p-5 transition-all group-hover:shadow-[0_6px_22px_-10px_rgba(15,23,41,0.22)] group-hover:border-[var(--rx-text-faint)]">
              <div className="flex items-center justify-between">
                <span className="text-[13px] font-medium text-[var(--rx-text-secondary)]">Companies</span>
                <div className="w-[34px] h-[34px] rounded-[9px] bg-[#fdf1e7] dark:bg-[#ea7a2c]/15 flex items-center justify-center">
              ...
              <div className="mt-[14px]">
                <span className="text-[32px] font-bold tracking-[-1px] text-[var(--rx-text-strong)] leading-none">{companies.toLocaleString()}</span>
              </div>
              <div className="mt-2 text-[12px] text-[var(--rx-text-muted)]">Active clients &amp; partners</div>
            </div>
          </Link>
        </div>
